...
<div className="OurTeam  div1">
    <div className="uarebest">
        <img src="https://cms.rome2rio.com/wp-content/uploads/2023/01/will_m-1-250x250.jpg" alt="" id="team"/>
       <h4>Will</h4> 
        <p>Will studied Computer Science at Swinburne University and has since worked on a number of exciting web applications.
