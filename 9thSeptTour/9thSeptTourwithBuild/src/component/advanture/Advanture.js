  ...
  return (
    <div>
      ...
      <div className={Styles.container}>
        <div>
          <p><a href={post.location_url} target='_blank'><img width="300px" height="300px" src={`http://192.34.63.158:4000/adventure/${post.image_url}`} /></a></p>
...
const Advanture = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post(`http://192.34.63.158:4000/adventure/add`, formData, {
        headers: {
